...
const connection = mysql.createConnection(process.env.DATABASE_URL='mysql://r28b66kzp2x99d0wv40r:pscale_pw_9BpUXky9KAD1kUurwys5woUhfdudcnhjALyIXygrHWq@aws.connect.psdb.cloud/proyecto?ssl={"rejectUnauthorized":true}');
